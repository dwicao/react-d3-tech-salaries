...
import { mean as d3mean, extent as d3extend } from 'd3-array';
...
class Title extends Component {
  ...
  get USstateFragment() {
    ...
    return USstate === '*' ? '' : USStateMap[USstate.toUpperCase()];
  }
  ...
  get format() {
    return scaleLinear()
            .domain(d3extend(this.props.data, d => d.base_salary))
            .tickFormat();
  }
